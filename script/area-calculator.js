...
3. iff needed some class 
4. set inner HTML. it could be dynamic template string.
5. append the created element as a child of the parents.
*/
...
3. Nan means: Not a numer --> isNaN is checking whether the input is not a number or not.
*/